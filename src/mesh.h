...
public:
    ...
    void drawInstanced(const Shader& drawingShader, const std::vector<glm::mat4>& instanceMatrices) const;

    void drawSkybox(const Shader &drawingShader);
    void drawCurve(int numOfPoints, float size);
    void drawParticle(float size);
